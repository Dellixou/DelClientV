...
public class BonzoWaypointCommand implements ICommand {
    @Override
    ...
    public void processCommand(ICommandSender sender, String[] args) throws CommandException {
        ...
        userRoute.addWaypoints(userRoute.currentEditRoute, x, y, z, false, false, false, false, player.rotationYaw, player.rotationPitch, true, RouteItem.NOTHING, false, true, false, 0);
        DelClient.sendChatToClient("&7Bonzo placed : &8" + userRoute.currentEditRoute.getName());
