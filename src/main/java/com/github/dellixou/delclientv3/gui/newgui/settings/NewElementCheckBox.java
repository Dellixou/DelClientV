package com.github.dellixou.delclientv3.gui.newgui.settings;
...
import com.github.dellixou.delclientv3.gui.newgui.NewModuleButton;
...
public class NewElementCheckBox extends NewElement {
	...
	/* Constructor */
	public NewElementCheckBox(NewModuleButton iparent, Setting iset) {
		parent = iparent;
		set = iset;
		xCircle = x + 2;
		targetXCircle = x + 2;
